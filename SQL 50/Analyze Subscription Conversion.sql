-- Source: https://leetcode.com/problems/analyze-subscription-conversion/solutions/6950307/simple-best-solution-by-iqbaldiit-za0c/
	/*
	Table: UserActivity
...
--create table
CREATE TABLE UserActivity (user_id INT,activity_date DATE,activity_type VARCHAR(20),activity_duration INT)

--Insert User Activity Table 
