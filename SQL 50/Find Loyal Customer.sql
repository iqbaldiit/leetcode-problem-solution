...
--Create table
CREATE TABLE customer_transactions (transaction_id INT,customer_id INT,transaction_date DATE,amount DECIMAL(10,2),transaction_type VARCHAR(20))

--insert customer_transactions tables
