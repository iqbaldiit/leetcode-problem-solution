--Source(MySQL): https://leetcode.com/problems/dna-pattern-recognition/solutions/6782212/simple-best-solution-by-iqbaldiit-hp2l/
--Source(MSSQL, MySQL, PostGreSQL, Oracle): https://leetcode.com/problems/dna-pattern-recognition/solutions/6785212/simple-best-solution-by-iqbaldiit-9ral/
/*
	Table: Samples
...
--Create table
CREATE TABLE Samples (sample_id INT,dna_sequence VARCHAR(100),species VARCHAR(50));

INSERT INTO Samples (sample_id, dna_sequence, species) VALUES
(1, 'ATGCTAGCTAGCTAA', 'Human'),(2, 'GGGTCAATCATC', 'Human'),(3, 'ATATATCGTAGCTA', 'Human'),
