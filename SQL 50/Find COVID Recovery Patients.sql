...
--Source (PostgreSQL): https://leetcode.com/problems/find-covid-recovery-patients/solutions/6886780/simple-best-solution-by-iqbaldiit-ne0c/
/*
	Table: patients
...
--            CAST(N.neg_date - N.pos_date AS INTEGER) AS recovery_time
--     FROM neg N 
